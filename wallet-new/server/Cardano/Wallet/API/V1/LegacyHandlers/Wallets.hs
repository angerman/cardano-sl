...
createNewExternalWallet walletMeta encodedExtPubKey = do
    ...
    -- of external wallet. Build 'WalletId' from it.
    ...
    -- Add initial account in this wallet.
    let accountMeta    = V0.CAccountMeta { caName = "Initial account" }
        accountInit    = V0.CAccountInit { caInitWId = cwId, caInitMeta = accountMeta }
        includeUnready = True -- Because we want to work with this wallet even if is not ready yet...
        passphrase     = mempty
